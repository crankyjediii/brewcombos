...
- "extras": zero or more of softtop (7 Brew's sweet cream topping, cold drinks only), coldfoam (cold drinks only), whip, caramel (drizzle), chocolate (dark chocolate drizzle), whitechoc (white chocolate drizzle), shot (coffee only), cream (energy/fizz/lemonade only), lightice (iced only).
